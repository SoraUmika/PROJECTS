...
type UpdateContactUnReadCount = {
	type: 'DATA::contact::unReadCount::<update>';
	payload: PLUserId & { num: number };
};

type ClearContactUnReadCount = {
	type: 'DATA::contact::unReadCount::<reset>';
	payload: PLUserId;
}